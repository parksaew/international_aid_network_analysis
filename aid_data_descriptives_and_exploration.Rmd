...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      textOutput("aidTrendsTitle"), 

      plotOutput(outputId = "aidTrends"),
      
      h3("Economic Trends"),
      plotOutput(outputId = "economicTrends", #need to build
                 height = "200px")
    )
  )
)
...
server = function(input, output) {
  ...
  output$aidTrendsTitle <- paste("Aid Trends by Type: from", input$donorRegion, "to", input$recipientRegion,
                                 sep = " ")
