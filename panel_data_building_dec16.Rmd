...
Other datasets:
  ...
  - World Bank - Unemployement (1959 -2017)
...
mergedata2 <- left_join(mergedata1, #JUNE 10 NOTE: mergedata1 is crs_ips. DF and variable names have to be updated
                       select(controls,
                              cowcode,
                              year,
                              conflict_prioryear,
