...
#leading the "year" variable so that all controls are lagged
...
crs_ip_country_controls <- crs_ip %>%
  left_join(original_controls_unlagged %>% #merge data for recipient countries (used the unlagged one because dyad data are unlagged)
              select(cowcode,
                     year,
                     country,
                     conflict_prior_year,
